        ...
        <AperkutMenu.Wrapper isMenuOpen={isMenuOpen}>
            <div className="container">
                ...
                <nav>
                    ...
                    <div>
                        <input placeholder="Pesquisar no Aperkut" />
                    </div>
                </nav>
...
function AperkutMenuProfileSidebar({ githubUser }) {
    return (
        <div className="AperkutMenuProfileSidebar">
            <div>
...
// AperkutProfileSidebarMenuDefault
// ================================================================================================================
export function AperkutProfileSidebarMenuDefault() {
    return (
...
AperkutProfileSidebarMenuDefault.Wrapper = styled.div`
  a {
    font-size: 12px;
    color: #2E7BB4;
    margin-bottom: 16px;
...
// ================================================================================================================
export function AperkutNostalgicIconSet(props) {
    return (
        <AperkutNostalgicIconSet.List>
            {[
                ...
                <li key={`Aperkut__icon_set__${slug}`}>
                    <span style={{ gridArea: 'title' }} className="AperkutNostalgicIconSet__title">
                        {name}
                    </span>
            ...
            {[
                ...
                return (
                    <li key={`Aperkut__icon_set__${slug}`}>
                        <span className="AperkutNostalgicIconSet__title">
                            {name}
                        </span>
...
AperkutNostalgicIconSet.List = styled.ul`
  margin-top: 32px;
  list-style: none;
  display: flex;
  justify-content: space-between;
  ...
  li {
    ...
    .AperkutNostalgicIconSet__title {
      display: block;
      font-style: italic; 
    }
    .AperkutNostalgicIconSet__number {
      min-width: 15px;
      display: flex;
      align-items: center;
      justify-content: flex-start;
      .AperkutNostalgicIconSet__iconSample {
        margin-right: 7px;
      }
    }
  }
...
// Reset Styles
// ================================================================================================================
export const AperkutStyles = css`
  *::-webkit-scrollbar {
    width: 8px;
  }
